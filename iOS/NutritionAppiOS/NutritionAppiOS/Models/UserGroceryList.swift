...
class UserGroceryList {

    var groceryListDictionary: [String: [[String: Any]]] = [:]
    ...
    /*
        ...
        Builds a grocery list by finding the date of the last instance of the users preferred start day, and adding 7 consecutive days of empty collections as values to the date keys.
    ...
    init(_ userPreferredStartDay: String) {
        ...
        for _ in 0..<7 {
            ...
            groceryListDictionary[formattedDate] = [[:]]
